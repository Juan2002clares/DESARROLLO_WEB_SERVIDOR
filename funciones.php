...
function pie()
{
    ...
    print "      Creado por Juan Enrique Clares Torrente\n";
    print "    </p>\n";
    print "\n";
    print "  </footer>\n";
}
...
function cabecera($texto, $menu)
{
    ...
    if ($menu == MENU_PRINCIPAL) {
        ...
        print "<li><a href='insertar.php'>Insertar</a></li>\n";
        print "<li><a href='borrar1.php'>Borrar</a></li>\n";
        print "<li><a href='borrado1.php'>Borrar todo</a></li>\n";
